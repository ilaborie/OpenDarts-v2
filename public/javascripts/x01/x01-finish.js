...
var x01Finish = {
    db: {
        ...
        getFinish: function (score, callback) {
            // Add
            var key = "x01Finish-" + score;
...
var appendFinish = function ($elt, score) {
    x01Finish.db.getFinish(score, function (json) {
        displayFinish($elt, score, json);
    });
};


var displayFinish = function ($elt, score, json) {
