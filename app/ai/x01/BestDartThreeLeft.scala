...
object BestDartThreeLeft extends BestDart {
	...
	private val bestDarts3: Map[Int, DartChoice] = Map(
		...
		137 -> T20,
		136 -> T20,
		135 -> (DoubleBull butSometime T20),
		134 -> T20,
		133 -> T20,
		132 -> (DoubleBull butSometime T20),
		131 -> T19,
		130 -> T20,

		// 12x
		129 -> (T19 butSometime DoubleBull),
		128 -> T18,
		127 -> T20,
		126 -> T19,
		...
		115 -> (T20 butSometime DoubleBull),
		...
		97 -> T19,
		96 -> T20,
		95 -> (DoubleBull withPressureOtherwise (DoubleBull or T19)),
		...
		82 -> (T14 or DoubleBull),
		81 -> (T19 or DoubleBull),
		80 -> (T20 or T16),
		...
		66 -> (T10 butSometime T16),
		65 -> (SemiBull butSometime T15),
		64 -> (T16 butSometime T14),
		63 -> T13,
		62 -> (T10 butSometime T12),
		61 -> (SemiBull butSometime T11),
		60 -> T20,
		...
		47 -> (S15 butSometime (S7 or S19)),
		46 -> (S6 butSometime (S14 or S10)),
		45 -> (S5 butSometime (S13 or S7 or S19)),
		44 -> (S4 butSometime (S8 or S16 or S18 or S12)),
